...
if (strlen($_SESSION['bbdmsdid']==0)) {
 ...
 if(isset($_POST['update']))
  ...
  $sql="update tblblooddonars set FullName=:name,MobileNumber=:mno, Age=:age,Gender=:gender,Address=:address,Message=:message  where id=:uid";
...
{               ?>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="mobileno" id="mobileno" required="true" maxlength="10" pattern="[0-9]+" value="<?php  echo $row->MobileNumber;?>" readonly>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="age" id="age" required="" value="<?php  echo $row->Age;?>" readonly>
</div>
						<div class="form-group">
							<label for="datepicker" class="col-form-label">Address</label>
							<input type="text" class="form-control" name="address" id="address" required="true" value="<?php  echo $row->Address;?>" readonly>
						</div>						
						<?php $cnt=$cnt+1;}} ?>
