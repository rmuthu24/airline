                ...
                <div class="container">
                    ...
                    <h1>
                        <a class="navbar-brand font-weight-bold font-italic" href="index.php">
                            <span style="color: white;">AIR</span>IND</span>                         
                        </a>
                    </h1>
                    <!-- //logo -->
                    ...
                    <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-lg-auto">
                            ...
                            <li class="nav-item mx-lg-4 my-lg-0 my-3">
                                <a class="nav-link" href="chatbot">Queries</a>
                            </li>

                            <?php if (strlen($_SESSION['bbdmsdid']!=0)) {?>
                                <li class="nav-item mx-lg-4 my-lg-0 my-3">
                                <a class="nav-link" href="donor-list.php">Book Tickets</a>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="user-orders.php">Your Orders</a>
                                    <div class="dropdown-divider"></div>
