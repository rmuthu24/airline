...
if($query -> rowCount() == 0)
{
$sql="INSERT INTO  tblblooddonars(FullName,MobileNumber,EmailId,Age,Gender,Address,status,Password) VALUES(:fullname,:mobile,:email,:age,:gender,:address,:status,:password)";
