	...
	<div class="breadcrumb-agile">
		<div aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Search Product List</li>
			</ol>
		</div>
	</div>
	<!-- //page details -->
...
<div class="font-italic">Search model<span style="color:red">*</span> </div>
...
$sql = "SELECT * from tblbloodgroup where (status=:status and BloodGroup=:bloodgroup)";
$query = $dbh -> prepare($sql);
...
{ ?>
			...
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">Search For Bangles</h3>
				<span>
...
{ ?>
					...
					<div class="price-top">
						<a href="single.html">
							<img src="<?php echo $result->image;?>" alt="Blood Donor" style="border:1px #000 solid" class="img-fluid" />
						</a>
